...
python compute_score.py \
    ...
    -l java -a -v -o combined_fl_results/d4j_gpt3_results_R1.json

python compute_score.py \
    results/d4j_autofl_1/gpt-3.5-turbo-0613 \
    results/d4j_autofl_2/gpt-3.5-turbo-0613 \
    -l java -a -v -o combined_fl_results/d4j_gpt3_results_R2.json

python compute_score.py \
    results/d4j_autofl_1/gpt-3.5-turbo-0613 \
    results/d4j_autofl_2/gpt-3.5-turbo-0613 \
    results/d4j_autofl_3/gpt-3.5-turbo-0613 \
    -l java -a -v -o combined_fl_results/d4j_gpt3_results_R3.json
...
python compute_score.py \
    ...
    -l java -a -v -o combined_fl_results/d4j_gpt3_results_R4.json
...
python compute_score.py \
    ...
    -l java -a -v -o combined_fl_results/d4j_gpt3_results_R5.json

# Defects4J (AUTOFL-GPT-4)
python compute_score.py \
    results/d4j_autofl_1/gpt-4-0613 \
    -l java -a -v -o combined_fl_results/d4j_gpt4_results_R1.json

python compute_score.py \
    results/d4j_autofl_1/gpt-4-0613 \
    results/d4j_autofl_2/gpt-4-0613 \
    -l java -a -v -o combined_fl_results/d4j_gpt4_results_R2.json
...
python compute_score.py \
    ...
    -l java -a -v -o combined_fl_results/d4j_llmtest_results.json

# BugsInPy (AUTOFL-GPT-3.5)
python compute_score.py \
    results/bip_autofl_1/gpt-3.5-turbo-0613 \
    -l python -a -v -o combined_fl_results/bip_gpt3_results_R1.json

python compute_score.py \
    results/bip_autofl_1/gpt-3.5-turbo-0613 \
    results/bip_autofl_2/gpt-3.5-turbo-0613 \
    -l python -a -v -o combined_fl_results/bip_gpt3_results_R2.json

python compute_score.py \
    results/bip_autofl_1/gpt-3.5-turbo-0613 \
    results/bip_autofl_2/gpt-3.5-turbo-0613 \
    results/bip_autofl_3/gpt-3.5-turbo-0613 \
    -l python -a -v -o combined_fl_results/bip_gpt3_results_R3.json
...
python compute_score.py \
    ...
    -l python -a -v -o combined_fl_results/bip_gpt3_results_R4.json
...
python compute_score.py \
    ...
    -l python -a -v -o combined_fl_results/bip_gpt3_results_R5.json

# BugsInPy (AUTOFL-GPT-4)
python compute_score.py \
    results/bip_autofl_1/gpt-4-0613 \
    -l python -a -v -o combined_fl_results/bip_gpt4_results_R1.json

python compute_score.py \
    results/bip_autofl_1/gpt-4-0613 \
    results/bip_autofl_2/gpt-4-0613 \
    -l python -a -v -o combined_fl_results/bip_gpt4_results_R2.json
...
python compute_score.py \
    ...
    -l python -a -v -o combined_fl_results/bip_llmtest_results.json